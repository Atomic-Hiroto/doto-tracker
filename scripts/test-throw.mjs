...
import { parseThrowArgs, throwReport } from '../dist/commands/throw.js';
...
try {
  ...
  assert.match(embed.fields[2].value, /9 shared matches excluded/);
  assert.match(embed.fields[2].value, /Not enough/);
