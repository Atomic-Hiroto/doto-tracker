...
\`+register @user <steam_id>\` - Register another user (owner/server manager)
...
export const PROVIDE_STEAM_ID = 'Please provide a Steam ID. Usage: +register <steam_id> or +register @user <steam_id>';
...
export const REGISTER_SUCCESS_FOR = (discordId: string, steamId: string) => `Successfully registered <@${discordId}> with Steam ID: ${steamId}. Auto-show is enabled by default.`;
